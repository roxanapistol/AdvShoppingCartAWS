...
def check_homepage():
    ...
    #Checking to see if "SPEAKERS", "TABLETS", "LAPTOPS", "MICE" are displayed:
    ...
    # Checking to see if "SPECIAL OFFER", "POPULAR ITEMS", "CONTACT US" are clicklable:
    ...
    # Contact Us form filling using random function:
